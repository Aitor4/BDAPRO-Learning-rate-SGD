...
import org.apache.spark.mllib.regression.{GeneralizedLinearAlgorithmWithAdaSGD, LabeledPoint}
import org.apache.spark.mllib.util.DataValidators
import org.apache.spark.rdd.RDD


/**
  * Classification model trained using SVM with an adaptive updater
  * and extending our GeneralizedLinearAlgorithmWithAdaSGD class
  *
  *  The class is based on the trait "SVM" from org.apache.spark.mllib.classification
...
class SVMWithAdaSGD(private var stepSize: Double,
                     ...
                     private var updater: AdaptiveUpdater) extends GeneralizedLinearAlgorithmWithAdaSGD[SVMModel] with Serializable {
  ...
  object SVMWithAdaSGD {
    ...
    def train(
               ...
               miniBatchFraction: Double,
               updater: AdaptiveUpdater): SVMModel = {
      new SVMWithAdaSGD(stepSize, numIterations, regParam, miniBatchFraction, updater).run(input)._1
    }
