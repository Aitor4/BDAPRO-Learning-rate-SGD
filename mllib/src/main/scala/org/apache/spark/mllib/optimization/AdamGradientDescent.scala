...
class AdamGradientDescent private[spark] (private var gradient: Gradient, private var updater: AdamUpdater)
  ...
  def optimize(data: RDD[(Double, Vector)], initialWeights: Vector): Vector = {
    val (weights, _) = AdamGradientDescent.runMiniBatchSGD(
      data,
      gradient,
      updater,
      stepSize,
...
/**
  ...
  */
@DeveloperApi
object AdamGradientDescent extends Logging {
  /**
  ...
  def runMiniBatchSGD(
    ...
    AdamGradientDescent.runMiniBatchSGD(data, gradient, updater, stepSize, numIterations,
