...
class AdamaxGradientDescent private[spark] (private var gradient: Gradient, private var updater: AdamaxUpdater)
  ...
  /**
    ...
    */
  def setUpdater(updater: AdamaxUpdater): this.type = {
  ...
  def optimize(data: RDD[(Double, Vector)], initialWeights: Vector): Vector = {
    val (weights, _) = AdamaxGradientDescent.runMiniBatchSGD(
      data,
      gradient,
      updater,
      stepSize,
...
/**
  ...
  */
@DeveloperApi
object AdamaxGradientDescent extends Logging {
  /**
  ...
  def runMiniBatchSGD(
    ...
    AdamaxGradientDescent.runMiniBatchSGD(data, gradient, updater, stepSize, numIterations,
