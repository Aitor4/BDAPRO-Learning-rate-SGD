...
class MomentumGradientDescent private[spark] (private var gradient: Gradient, private var updater: MomentumUpdater)
  ...
  /**
    ...
    */
  def setUpdater(updater: MomentumUpdater): this.type = {
  ...
  def optimize(data: RDD[(Double, Vector)], initialWeights: Vector): Vector = {
    val (weights, _) = MomentumGradientDescent.runMiniBatchSGD(
      data,
      gradient,
      updater,
      momentumFraction,
...
object MomentumGradientDescent extends Logging {
  ...
  def runMiniBatchSGD(
    ...
    MomentumGradientDescent.runMiniBatchSGD(data, gradient, updater, momentumFraction, stepSize, numIterations,
